...
# Pinned to a specific release tag instead of a moving branch so the downloaded
# project cannot silently change under a fixed reference (supply-chain safety).
# Bump this deliberately only after re-reviewing a newer release.
MPT_PINNED_REF = "v1.3.2"
PROJECT_ARCHIVE_URL = (
    "https://github.com/harry0703/MoneyPrinterTurbo/archive/"
    f"refs/tags/{MPT_PINNED_REF}.zip"
)
