...
Отобранная библиотека агентских скиллов для Claude Code. Источники (по состоянию на 11 июля 2026; MoneyPrinterTurbo и freecut — 16 июля):
...
### Медиа-генерация и dev-утилиты (адаптировано локально)

Взяты из репозиториев приложений (не из скилл-библиотек), поэтому адаптированы под общий репозиторий: MPT укреплён, два скилла freecut обобщены и очищены от привязки к их проекту.
